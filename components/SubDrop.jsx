...
function SubDrop() {
  return (
    <div>
        <DropdownMenu>
            <DropdownMenuTrigger className='flex focus:outline-none lg:mb-5 lg:ml-[7px] hover:bg-gray-700'>
            ...
            <DropdownMenuContent className='lg:ml-[450px] w-[300px] rounded-[10px] shadow-2xl lg:bg-[#FFF3F3] bg-[#c6bcbc]'>
                <DropdownMenuItem className="hover:bg-gray-700 lg:justify-start justify-around">
                    <Link href={'/'} className='flex'>
                        <MdCircle className="hidden lg:flex mt-[5px] mr-4 text-[10px] text-gray-600" />
                        VR: Air Canvas
                    </Link>                    
                </DropdownMenuItem>
                <DropdownMenuItem className="hover:bg-gray-70 lg:justify-start justify-around">
                    <Link 
                        href={'/'} 
                        className='flex'>
                        <MdCircle className="hidden lg:flex mt-[5px] mr-4 text-[10px] text-gray-600" />
